...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="groupList" class="nav navbar-nav">
                    ...
                    <li><button type="button" id="show_contacts" class="btn btn-default navbar-btn">Show Contacts</button></li>
                </ul>
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><b>Contacts in group</b></td>
        </tr>
        </thead>
        <c:forEach items="${groups}" var="groups">
            <tr>
                <td><input type="checkbox" name="toDelete[]" value="${groups.id}" id="checkbox_${groups.id}"/></td>
                <td>${groups.name}</td>
                <td>${groups.contacts.size()}</td>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <c:forEach var="i" begin="1" end="${pages}">
                <li><a href="/group?page=<c:out value="${i - 1}"/>"><c:out value="${i}"/></a></li>
            </c:forEach>
        </ul>
    </nav>
</div>
